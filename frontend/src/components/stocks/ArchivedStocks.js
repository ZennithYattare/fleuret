          ...
          data.rows.push({
            ...
            actions: (
              <div className="btn-group" role="group">
                ...
                <button
                  className="btn fa-solid fa-arrow-rotate-left fa-xl"
                  title="Restore Stock"
                  disabled={stock.isSold || stock.isExpired || stock.autoArchive ? true : false}
                  onClick={() => restoreStock(stock._id)}
                ></button>
                <button
                  className="btn fa-solid fa-trash fa-xl"
                  title="Delete Stock"
